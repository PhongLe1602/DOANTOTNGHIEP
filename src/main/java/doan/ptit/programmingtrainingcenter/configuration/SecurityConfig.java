...
public class SecurityConfig {
    ...
    private final String [] PUBLIC_ENDPOINTS = {"/api/review/**","/api/auth/**" ,"/api/categories/**","/api/courses/**","/api/sections/**","/api/lessons/**","/api/enrollments/**","/api/payment-method/**","/api/payments/**","/api/schedule/**","/api/carts/**"};
